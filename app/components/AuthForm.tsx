        ...
        <div>
          ...
          <div className="relative rounded-md shadow-sm">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 bg-white/20 border border-white/30 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-white"
